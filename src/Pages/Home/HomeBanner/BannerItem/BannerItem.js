  ...
  return (
    ...
    <div className="w-full h-full">
      ...
      <div className="w-full h-full absolute top-0 flex justify-center items-center flex-col">
        <h1 className="font-bold text-7xl text-yellow-500">welcome to BookShelf</h1>
        <p className="text-center w-1/3 font-bold text-xl text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id repellendus excepturi quisquam eum quam nesciunt ab nulla culpa magnam cupiditate?</p>
      </div>
    </div>
  );
};
